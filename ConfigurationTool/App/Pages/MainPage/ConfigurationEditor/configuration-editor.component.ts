...
import { ConfigurationInstanceCLO, FeatureSelectionCLO, AttributeValueCLO, FeatureSelectionStates, GroupCLO, iCLO } from 'app/core/clofactory/clos';
import { MainPageDataStore } from '../main-page.data-store';

@Component({
    moduleId: module.id,
    selector: 'configuration-editor',
    templateUrl: "configuration-editor.component.html" + "?tmplv=" + Date.now(),
    styleUrls: ['configuration-editor.component.css' + "?tmplv=" + Date.now()]
})
export class ConfigurationEditorComponent {
    ...
    // Constructor
    public constructor(private componentFactoryResolver: ComponentFactoryResolver, private mainPageDataStore: MainPageDataStore) { }
