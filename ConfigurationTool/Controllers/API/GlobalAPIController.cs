...
using OpenConfigurator.ConfigurationTool.WebUI.Code;
...
namespace OpenConfigurator.ConfigurationTool.WebUI.Controllers
{
    public class GlobalAPIController : Controller
    {
        ...
        public GlobalAPIController(IHostingEnvironment env)
        {
            _env = env;

            _modelFolderPath = _env.ContentRootPath + "\\ModelFiles\\";
            _configurationInstanceFolderPath = _env.ContentRootPath + "\\ConfigurationFiles\\";
        }
        ...
        public ConfigurationInstance GetConfigurationInstance(string modelName)
        {
            ...
            HttpContext.Session.SetObject("configuratorSession", configSession);
        ...
        public Dictionary<string, object> ToggleFeatureSelection([FromBody]string featureID)
        {
            ...
            ConfiguratorSession configSession = HttpContext.Session.GetObject< ConfiguratorSession>("configuratorSession");
